...
@interface BTBaseWebViewController ()<UIWebViewDelegate>
...
@implementation BTBaseWebViewController
...
- (void)viewDidLoad {
    ...
    titleItemCustomView.text = _toolTitle;
    ...
    if (_isRequest) {
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
            ...
            NSURLRequest *request = [[NSURLRequest alloc] initWithURL:url cachePolicy:NSURLRequestReloadIgnoringCacheData timeoutInterval:5.0];
...
- (void)loadWithURLString:(NSString *)urlString title:(NSString *)title isRequest:(BOOL)isRequest
{
